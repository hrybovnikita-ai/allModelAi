...
export default function NextTwentyFive(){
 ...
 return <main className="next-ten-page next-25-page">
  <header className="next-ten-nav"><Link to="/dashboard" className="next-ten-brand"><b>AI</b>AllModelAI</Link><nav><Link to="/next-9">Research & Learning</Link><Link to="/next-10">Model Toolkit</Link><Link to="/dashboard">Dashboard</Link></nav></header>
