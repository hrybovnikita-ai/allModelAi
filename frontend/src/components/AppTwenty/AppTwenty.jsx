...
export default function AppTwenty(){
 ...
 return <main className="next-ten-page next-25-page"><header className="next-ten-nav"><Link to="/dashboard" className="next-ten-brand"><b>AI</b>AllModelAI</Link><nav><Link to="/next-20">Workspace Tools</Link><Link to="/control-center">Control</Link><Link to="/dashboard">Dashboard</Link></nav></header>
